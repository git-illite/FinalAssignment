...
function toggleLoading(isLoading) {
  ...
  var SButtonText = document.getElementById("searchicon");
  SButtonText.innerHTML = "";

  var SIcon = document.createElement("i");
  var loading;

  if (isLoading) {
    SIcon.className = "fas fa-hourglass-half";
    loading = document.createTextNode("Loading...");
    SButton.disabled = true;
  } 
  else {
    SIcon.className = "fas fa-search";
    loading = document.createTextNode("Search");
    SButton.disabled = false;
  }
  SButtonText.append(SIcon);
  SButtonText.append(loading);
}
